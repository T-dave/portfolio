...
function homeDisplay(){
	content.innerHTML = "<p class = 'animated fadeIn' style='padding-top: 0;'>Hi...</p><p class = 'animated fadeIn'>My name is David Omotara</p><p class = 'animated fadeIn'>I'm a front end developer with a passion for pushing myself beyond my limts</p><button class='hire button animated fadeIn' onclick = 'hireDisplay()'>Contact Me</button>";
...
function serviceDisplay(){
	content.innerHTML = "<h3 class = 'animated fadeIn'>My services include</h3><ul class = 'animated fadeIn'><li>Website Building</li><li>PSI to HTML</li><li>Code Correction/ Cleaning</li><li>Wordpress Development</li><li>Plugin Installation</li><li>HTML to Wordpress</li><li>Custom Wordpress Theme</li></ul><button class='hire button' onclick = 'hireDisplay()'>Contact Me</button>";
	content.classList.remove('skl');
...
function skillDisplay(){
	content.innerHTML = "<div class = 'animated fadeIn' id='hexagon' style='font-family: sans-serif;'>HTML</div><div class = 'animated fadeIn' id='hexagon' style='font-family: sans-serif;'>CSS</div><div class = 'animated fadeIn' id='hexagon' style='font-family: sans-serif;'>JAVASCRIPT</div><div class = 'animated fadeIn' id='hexagon' style='font-family: sans-serif;'>BOOTSTRAP</div><div class = 'animated fadeIn' id='hexagon' style='font-family: sans-serif;'>WORDPRESS</div><div class = 'animated fadeIn' id='hexagon' style='font-family: sans-serif;'>REACT</div><button class='hire button' onclick = 'hireDisplay()'>Contact Me</button>";
...
function hireDisplay(){
	content.innerHTML = "<div class='form animated fadeIn'><h2>Get in Touch</h2><form action='mailto:tomyomo@gmail.com' method='POST' enctype='multipart/form-data' name='EmailForm'><div class='name-email'><div class='flex-form'>Name<br><input type='text' name='name' placeholder='Name'></div><div class='flex-forma'>Email<br><input type='text' name='email' placeholder='email'></div></div><div class='textarea'>Message<br><textarea>Message</textarea></div><input type='submit' value='Send Message' class='hireh'></form></div>";
	content.classList.remove('skl');
